...
完整变更见 [v1.8.83 Release Notes](docs/releases/v1.8.83.md)，架构与开发约定见 [开发文档](Mihomo-macOS-development-report.md)。
...
export http_proxy=http://127.0.0.1:6152
export all_proxy=socks5://127.0.0.1:6153
./script/package_release.sh 1.8.83
./script/release_smoke_test.sh 1.8.83
```

产物位于 `dist/releases/`：

- `Mihomo-1.8.83-macOS-arm64.zip`
- `Mihomo-1.8.83-update.json`
- `mihomo-update.json`
- `Mihomo-1.8.83-provenance.md`
