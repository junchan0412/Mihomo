...
- Expanded diagnostics for binary, Helper health, version, runtime dry-run, Controller, TUN status, system proxy snapshots, redacted runtime/log exports, subscription queues, advanced fragments, managed core, remote API, external UI, Geo data, and refresh failures.
