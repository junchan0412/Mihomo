...
完整变更见 [v1.8.81 Release Notes](docs/releases/v1.8.81.md)，架构与开发约定见 [开发文档](Mihomo-macOS-development-report.md)。
...
- `Mihomo-1.8.81-macOS-arm64.zip`
- `Mihomo-1.8.81-update.json`
- `mihomo-update.json`
- `Mihomo-1.8.81-provenance.md`
